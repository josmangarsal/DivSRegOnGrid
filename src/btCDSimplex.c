...
/*---------------------------------------------------------------------------*/
void PrintBTCDSSubTreeInOrder(PBTCDSNODE node, INT NDim, PPREAL ppVCoorT, 
                   PPREAL ppCDSToVMat)
{
 if (node!=NULL)
    {
...
/*---------------------------------------------------------------------------*/
void PrintBTCDSSubTree(PBTCDSNODE node, INT NDim, PPREAL ppVCoorT, 
                   PPREAL ppCDSToVMat)
{
 if (node!=NULL)
    {
 ...
 *pAdd=False;
 pbtcds->pFirstBTCDSNode=InsertBTCDS1(pbtcds->pFirstBTCDSNode, 
                                      pCDS,NDim,&taller,pAdd);
 if (*pAdd==True)
    {
     pbtcds->NElem++;
