...
VOID ReadProblem(PCHAR FileName, PCHAR ProblemName, PINT pNDim, PINT pNLC, PPPREAL pppLC, PPREAL ppCostV, PPREAL ppCostP, PPREAL ppMaxFeasRad,
		PINT pNQC, PPPPREAL ppppA, PPPREAL pppB, PPREAL ppD);
VOID MinMaxEigenValue(PPREAL ppA, INT NDim, INT NNQC, PPREAL ppMinMaxEigenV);
