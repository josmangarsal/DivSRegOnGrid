...
VOID       PrintCDSimplex      (PCDSIMPLEX pCDS, INT NDim, PPREAL ppVCoorT,
                                PPREAL ppCDSToVMat);
VOID       StoreVertexCDSimplex(PCDSIMPLEX pCDS,PPREAL ppVCoorT,
                                PPREAL ppCDSToVMat, PBTV pbtv, INT NDim,
                                PBTV pbtvGridPoints);
VOID       DrawCDSimplex       (PCDSIMPLEX pCDS, PPREAL ppVCoorT,
			                          PPREAL ppCDSToVMat,
